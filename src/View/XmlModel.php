...
use zPetr\ApigilityXml\Serializer\Adapter\Xml as XmlSerializer;
use Traversable;
...
/**
 * Class XmlModel
 * @package zPetr\ApigilityXml\View\Model
 */
class XmlModel extends ViewModel
{
    ...
    public function serialize()
    {
        ...
        if($payload instanceof Collection){
            ...
            $output = array('type'=>'collection','data'=>$object->getCurrentItems(),'pages'=>$object->getPages());
        }
